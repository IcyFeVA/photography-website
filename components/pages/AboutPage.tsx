...
const AboutPage: React.FC = () => {
  return (
    <section className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <SEO
        title="About Pascal Zirn | Vancouver Photographer"
        description="Pascal Zirn is a Vancouver-based photographer with a background in Product Design. Specializing in headshots and portraits that solve problems."
        canonical="/about"
      />
