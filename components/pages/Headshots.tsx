      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
        <div className="space-y-4">
          <div className="aspect-[4/5] overflow-hidden rounded-sm">
            <img src="/img/theatrical1.webp" alt="Theatrical Headshot" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
        ...
        <div className="space-y-4 md:mt-24">
          <div className="aspect-[4/5] overflow-hidden rounded-sm">
            <img src="/img/commercial2.webp" alt="Commercial Headshot" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
