...
const Offer: React.FC = () => {
    return (
        <section className="pt-32 pb-24 px-6 w-full min-h-screen relative overflow-hidden bg-background">
            ...
            {/* Background Decor — soft glows drawn as radial gradients. Don't use filter: blur() here:
                mobile Safari repaints large blurs on the CPU and shows a black page for seconds. */}
            <div className="absolute top-[-10%] left-[-10%] w-96 h-96 scale-[2.5] bg-[radial-gradient(closest-side,rgba(255,255,255,0.035),rgba(255,255,255,0.015)_50%,transparent)] pointer-events-none"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 scale-[2.25] bg-[radial-gradient(closest-side,rgba(255,255,255,0.04),rgba(255,255,255,0.018)_50%,transparent)] pointer-events-none"></div>
                ...
                >
                    ...
                    <div className="space-y-4 pt-4">
                        ...
                        <p className="text-xs text-red-500 uppercase tracking-wider font-sans">
                            * Mention this ad when booking! Offer ends on September 31st, 2026.
                        </p>
                    </div>
                </motion.div>
