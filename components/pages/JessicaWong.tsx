...
const JessicaWong: React.FC = () => {
    return (
        <section className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen flex flex-col items-center">
            <SEO
                title="Jessica Wong | Private Gallery Download"
                description="Private download page for Jessica Wong's photography session."
            ...
            >
                <div className="p-8 border border-white/10 rounded-lg bg-white/5 backdrop-blur-sm max-w-xl mx-auto">
                    ...
                    <a
                        href="https://drive.google.com/drive/folders/1CnFaw48l-wSP3iIpMTBKLvZ5X7SKp2FT?usp=sharing"
                        target="_blank"
