...
const InokaVera: React.FC = () => {
    return (
        <section className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen flex flex-col items-center">
            <SEO
                title="Inoka Vera | Private Gallery Download"
                description="Private download page for Inoka Vera's photography session."
            ...
            >
                ...
                <div className="aspect-[5/4] overflow-hidden rounded-sm bg-subtle">
                    <img
                        src="/img/download_inako_vera_web2.webp"
