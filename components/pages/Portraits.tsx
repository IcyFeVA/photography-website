...
const Portraits: React.FC = () => {
  return (
    <section className="pt-32 pb-24 px-6 max-w-7xl mx-auto min-h-screen">
      <SEO
        title="Vancouver Portrait Photographer | Editorial & Family"
        description="Editorial-style portrait photography for executives and families in Vancouver. Capturing legacy and leadership with a modern aesthetic."
        canonical="/portraits"
      />
      <motion.div
